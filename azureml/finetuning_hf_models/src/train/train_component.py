...
@command_component(
    name="finetune_hf_models",
    version="1",
    display_name="Finetune HF Models",
    description="Finetune HF Models using PEFT"
)
def training_component(input_data: Input(type="uri_folder"), output_model: Output(type="uri_folder")):
